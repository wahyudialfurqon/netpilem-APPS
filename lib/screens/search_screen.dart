  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        Expanded(
        child: _searchResults.isEmpty ? const Center(child: Text('No Movies Found!', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)))
        : ListView.builder(
                          ...
                          decoration: BoxDecoration(
                            image: movie.posterPath != null && movie.posterPath.isNotEmpty
                                ? DecorationImage(
                                    ...
                                    fit: BoxFit.cover, // Gambar terisi penuh
                                  )
                                : null,
                          ),
